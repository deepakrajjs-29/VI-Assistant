  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="history-header">
        <div>
          <h2 className="section-title font-orbitron">Crop Diagnostics Log</h2>
          <p className="section-desc" style={{ marginBottom: 0 }}>Review historical crop logs, plant diagnostics, and agricultural insights.</p>
        </div>
        {history.length > 0 && (
          <button
            onClick={() => {
        ...
        <div className="cyber-card" style={{ padding: "48px", textAlign: "center", opacity: 0.5 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "0.75rem", color: "var(--text-muted)", maxWidth: "280px", margin: "6px auto 0 auto", lineHeight: "1.4" }}>
              {searchQuery ? "No matches found for your query." : "Your agricultural inspection timeline is empty. Capture crop images to generate records."}
            </p>
          </div>
        </div>
      ) : (
