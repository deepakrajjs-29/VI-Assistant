  ...
  return (
    <div className="chat-layout animate-fadeIn">
      ...
      <div className="chat-header">
        <div>
          <h2 className="section-title font-orbitron">Agronomist AI Chat</h2>
      ...
      <div className="cyber-card chat-messages">
        {chatHistory.length === 0 ? (
          <div className="loader-container" style={{ color: "var(--text-muted)", opacity: 0.5 }}>
            ...
            <h4 className="font-orbitron" style={{ fontSize: "0.85rem", fontWeight: "700" }}>AGRI-AI ONLINE</h4>
            <p style={{ fontSize: "0.75rem", maxWidth: "280px" }}>
              Hello! I am your Agri-Assistant agronomist model. Ask questions like "how to treat rust on wheat?" or "soil pH requirements for tomatoes" to begin.
            </p>
          </div>
        ) : (
          chatHistory.map((msg) => {
